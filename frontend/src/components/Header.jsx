      ...
      <div className='md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px]'>
        ...
        <div className='flex flex-col sm:flex-row gap-3 w-full'>
          ...
          {adminPanelUrl && (
            <a
              href={adminPanelUrl}
              className='flex items-center justify-center gap-2 bg-white/90 px-8 py-3 rounded-full text-gray-700 text-sm m-auto md:m-0 hover:scale-105 transition-all duration-300'
            >
              Admin / Doctor Panel
            </a>
          )}
